...
const Onboarding: React.FC = () => {
  ...
  const handleGetStarted = () => {
    navigate("/home"); // ✅ Navigate to AuthForm route
  };
    ...
    >
      <div className="onboarding-overlay">
        <div className="onboarding-content">
          ...
          {/* Dot indicators except on first slide */}
          {!slides[currentIndex].showOnlyLogo && (
            <div className="dots">
              {slides.map((_, index) => (
                <span
          ...
          {/* Show Get Started button if last slide */}
        ...
        {/* Navigation Buttons (not shown on last slide) */}
        {!slides[currentIndex].isLast && (
